...
// The single answer to "does this outcome move money". Both sweeps filter on
// exactly this set: the family is charged and the tutor is paid, or neither
// happens. There is no outcome that bills one side without the other.
//
...
//
// Everything else — cancelled_mutual, tutor_cancelled, waived — bills nobody.
const BILLABLE_OUTCOMES = ['delivered', 'partial', 'no_show', 'late_cancelled'];

module.exports = { assessCancellation, NOTICE_HOURS, BILLABLE_OUTCOMES };
